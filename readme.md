...
7.  [Code Craftsmanship](#code-craftsmanship)

8.  [Other Stories](#other-stories)
...
This doesn't cover 90% lines of the codes, but we will cover 90% lines of the codes with Route Test (Testing different components together).
...
{
	"Uber-1": {
		"order_details": {"order_number": 3, "pizzas": [{"size": "L", "type": "margherita", "toppings": {"beef": 2, "tomatoes": 1, "chicken": 3}, "number": 1, "item_id": 1}], "drinks": [], 
		"address": "200 Street", 
		"price": 24.0}
	}
}
